...
<body style="background-color: #ececec;">
	...
	<!-- 1	 -->
            ...
            <div class="row" style="background-color: #fff;padding-top: 20px;height: 500px;">
                <div class="col-md-12">
                    <!-- Advanced Tables -->
                    <div class="card">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
  ...
  ajaxgetNoShelfGoods();
             ...
             tr+="<td >"+datas[i].spName+"<input name='spId' type='hidden' id='spId' value='"+datas[i].spId+"'></td>";
              tr+="<td >"+datas[i].sptName+"<input name='spucId' type='hidden' id='spucId' value='"+datas[i].spucId+"'></td>";
               ...
               tr+="<td class='center'>"+datas[i].spAllNum+"</td>";
                tr+="<td class='center'>"+datas[i].dpName+" ("+datas[i].dnMaxNum+") "+"<input type='hidden' id='dnMaxNum' value='"+datas[i].dnMaxNum+"'></td>";
    ...
    var jsonArr=new Array();
     $('#mytbody  tr').each(function(i){                   // 遍历 tr
			  josnStr={"spId":$(this).find("input[name=spId]").val(),"spucId":$(this).find("input[name=spucId]").val()};
  ...
  // alert($(this).parent().parent().find("#dnMaxNum").val())
   var open=confirm("请确认你的操作！！");
  if(open==true){
            
             $.ajax({
          url:"updateApplyGoodsShelfCheck",
         ...
         //alert(datas);
           ...
           window.location.href="backStage/tlz/applyGoLook.jsp";
