...
<div id="title">
<ul class="breadcrumb">
<h3  style="color:#999999;">&nbsp;&nbsp;退货出库记录</h3>
</ul>

</div>
<div id="serch">
<input type="text" id="ipt" placeholder="请输入出库时间或者商品名称进行模糊，敲Enter查询"  v-on:keyup.enter="serch(this)">
</div>
...
<script>
	...
	limit   每页显示的条数
	*/
	function fenye(ck,pagenum,limit) {
		table.render({
			id : 'myTab', //table的id
			elem : '#myTab',   //同上
			height : 500,  //表格的高度
		   url : 'selck.action',
		    ...
		    {field : 'owUtilId',width : 150,title : '出库Id',sort : true,}, 
			{field : 'spName',width : 150,title : '商品名称',sort : true,}, 
			{field : 'owuNum',width : 150,title : '出库数量',sort : true,}, 
			{field : 'spName',width : 150,title : '商品名称',sort : true,}, 
			{field : 'owuPrice',width : 100,title : '单价',sort : true,}, 
			{field : 'whName',width : 150,title : '所在仓库',sort : true,}, 
			{field : 'owuAllMonery',width : 150,title : '退货总价',sort : true,}, 
			{field : 'owreason',width : 190,title : '出库原因',sort : true,}, 
			{field : 'owDate',width : 150,title : '出库时间',sort : true,}, 
			{field : 'ocRealName',width : 150,title : '操作人',sort : true,}, 
