...
<script type="text/javascript" src="backStage/assets/js/jquery.js"></script>
<script type="text/javascript" src="backStage/assets/js/layui.all.js"></script>
...
<link rel="stylesheet" href="backStage/assets/css/layui.css" type="text/css"></link>
<style>
.layui-table th{
font-size:20px;
text-align: center;
...
<script>
	...
	limit   每页显示的条数
	*/
	function fenye(to,pagenum,limit) {
		table.render({
			id : 'myTab', //table的id
			elem : '#myTab',   //同上
			height : 500,  //表格的高度
		   url : 'selto.action',
		    ...
		    {field : 'spId',width : 150,title : '商品编号',sort : true,}, 
