...
<head>
<base href="<%=basePath%>">
<title>My JSP '财务统计.jsp' starting page</title>
...
<link rel="stylesheet" href="backStage/zyq/css/layui.css"
	type="text/css"></link>
<link rel="stylesheet" href="backStage/zyq/css/cwtj.css" type="text/css"></link>
<link rel="stylesheet" href="backStage/zyq/css/layui.css"
	type="text/css"></link>
<script type="text/javascript" src="backStage/zyq/js/cwtj.js"></script>
...
<div id="box1">
		<ul id="nav" class="nav nav-tabs"
			...
			<li class="active"><a href="${path}/backStage/zyq/cwtj.jsp">财务统计</a>
			</li>
	</div>
	<div id="zz"></div><br/>
